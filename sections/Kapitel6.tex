...
\subsubsection{Ziele der Modularisierung}
...
\subsubsection{Unit-Schnittstelle definieren (in Headerdatei)}
...
\subsubsection{Reihenfolge in der Implementierungsdatei (*.cpp)}
