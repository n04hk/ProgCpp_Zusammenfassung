...
\section{Kapitel 5: Scope, Deklarationen, Type Casts}
...
\subsection{Gültigkeitsbereiche, Namensräume und Sichtbarkeit}
\label{sec:Gueltigkeitsbereiche, Namensraeume und Sichtbarkeit}

\subsubsection{Gültigkeitsbereiche von Namen (Scope)}
...
\subsubsection{Gültigkeitsbereiche in C++}
...
\subsubsection{Gültigkeit (Scope) von Variablen}
...
\subsubsection{Lebensdauer von Variablen}
...
\subsubsection{Schlussfolgerung (naheliegend aber falsch)}
...
\subsection{Namensräume (Namespaces)}
...
\subsubsection{Explizite Namensräume in C++}
...
\subsubsection{C++-Mechanismen für Namespaces}
...
\subsubsection{Deklaration von Namespaces}
...
\subsubsection{Deklaration von Namespaces: Beispiel}
...
\subsubsection{using-Deklaration}
...
\subsubsection{using namespace kann zu Konflikten führen}
...
\subsubsection{Namenlose Namespaces}
...
\subsubsection{Zugriff auf globale Variable mit Scope-Operator}
...
\subsection{Speicherklassen}
\label{sec:Speicherklassen}

\subsubsection{Speicherklassen in C++}
...
\subsubsection{Typqualifikationen (Kap. 9.2.2)}
...
\subsection{Type-Case (Typumwandlungen)}
\label{sec:Type-Case (Typumwandlungen)}

\subsubsection{Typumwandlungen im Allgemeinen}
