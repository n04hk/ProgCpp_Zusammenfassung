...
\subsubsection{Funktionen (Vergleich zu C)\hfill}
\label{sec:unterunterabschnitt}
\begin{itemize}
...
\subsubsection{Kosten einer Funktion\hfill}
\label{sec:unterunterabschnitt}
\begin{itemize}
...
\subsubsection{Beispiel mit C-Makro: Was passiert wirklich?\hfill}
\label{sec:unterunterabschnitt}
\noindent
\begin{minipage}{\linewidth}
\begin{lstlisting}
...
\subsection{Grundsätze für Optimierungen\hfill}
\label{sec:unterabschnitt}
...
\subsection{default-Argumente\hfill}
\label{sec:unterabschnitt}

\subsubsection{Vorbelegte Parameter (default-Argumente)\hfill}
\label{sec:unterunterabschnitt}
\begin{minipage}{\linewidth}
\begin{lstlisting}
...
\normalsize
\begin{itemize}
	\item Parametern können im Funktionsprototypen (\color{\ownRed}bitte nur dort!\color{black}) Defaultwerte zugewiesen werden.
...
\subsubsection{Beispiel: default-Argumente\hfill}
\label{sec:unterunterabschnitt}
\noindent
\begin{minipage}{\linewidth}
\begin{lstlisting}
...
\subsubsection{Überladen von Funktionen (overloading)\hfill}
\label{sec:unterunterabschnitt}
\begin{itemize}
	\item Zweck:
	\begin{itemize}
	...
	\begin{itemize}
		...
		\item[\-] \color{\ownRed} Ist umständlicher und unverständlicher\color{black}
 	\end{itemize}
\end{itemize}

\subsubsection{Overloading in C++\hfill}
\label{sec:unterunterabschnitt}
\begin{itemize}
...
\subsubsection{Deklaration von überladenen Funktionen: Regeln\hfill}
\label{sec:unterunterabschnitt}
\begin{itemize}
